...
parser.add_argument('-i', '--ip',help="insert the range (ex. -i 149.56.206.0/24), for scan more ranges separate them with ',' ")
parser.add_argument('-p', '--ports',help="insert the port range (ex. -p 25560-25580)",required=True)
parser.add_argument('-r', '--rate',help="insert the rate (ex. -r 10000) (default: 5000)",type=int,default=5000)
parser.add_argument('-c', '--check',help="for automatically check servers",action="store_true")
parser.add_argument('-f', '--file',help="insert the file with ranges (ex. -f ranges.txt)")
